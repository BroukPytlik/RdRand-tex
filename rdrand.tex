...
%============================================================================
\documentclass[cover,english]{jtulak} % odevzdani do wisu - odkazy, na ktere se da klikat
...
\projectinfo{
  ...
  od Intelu (Ivy Bridge RNG). Samotná instrukce je rovněž zběžně popsána, stejně jako základní
