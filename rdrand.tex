...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={RdRand, Intel CPU, náhodná čísla}, %klicova slova v ceskem jazyce
  keywords.en={RdRand, Intel CPU, random numbers}, %klicova slova v anglickem jazyce
  %Abstract
  ...
  od Intelu (Ivy Bridge RNG). Samotná instrukce je rovněž zběžně popsána, 
  stejně jako základní problematika generování náhodných čísel.\\ \\
  V první kapitole (Introduction) je stručné shrnutí historie a využití generování 
  náhodných čísel a shrnutí důvodů, proč jsem si vybral toto téma. 
  Druhá kapitola pojednává o možnostech generování náhodných čísel na deterministických strojích a popisuje princip generátoru náhodných čísel v Linuxovém jádře.
  Kapitola tři rozebírá funkčnost samotné instrukce RdRand a zmiňuje i potenciální rizika. Čtvrtá a pátá kapitola je věnována popisu a vysvětlení kódu, který je praktickým výstupem této práce a který je otestován jak po statistické, tak pro výkonnostní stránce v kapitole 6.},
  % abstrakt v anglickem jazyce
  abstract.en={This thesis describe implementation and testing of a Linux 
  library, created for providing an abstraction layer between an user and 
  the Intel's RdRand instruction (Ivy Bridge RNG). The instruction itself is briefly described
  here, as well as basics of random number generation.}, 
  %Prohlaseni
